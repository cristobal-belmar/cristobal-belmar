...
- Estudiante de **Ingeniería Estadística (último año)** — Universidad Católica del Maule.
- Interés en aprender cosas nuevas. 
- Interés en **modelos de regresión y clasificación**, **Machine Learning y Redes Neuronales**, **Visualizacion de datos**.
- Enfoque en **reproducibilidad** y el despliegue de dashboards interactivos para la toma de decisiones.
...
![Machine Learning](https://img.shields.io/badge/ML-Scikit--Learn-F7931E?logo=scikitlearn&logoColor=white)
...
- **Ayudante — Introduccion a las probabilidades** · 1 semestre
- **Ayudante — Introduccion al algebra** · 1 semestre
---

## 📫 Contacto

- **Email:** cristobal.belmar@alumnos.ucm.cl
